    ...
    <%@ page isELIgnored="false" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                ...
                <link rel="stylesheet"
                    href="https://staticfile.oto.com.vn/dist/web/styles/theme.min.css.gz?v=638029584077979519">
                ...
                <%@include file="../Component/header/Header.jsp" %>
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <%-- <div class="carousel-item">--%>
                                <%-- <img
                                    src="https://secure-ds.serving-sys.com/resources/PROD/asset/1073745238/IMAGE/20220830/Ecom APVN Oto.com 1920x350_73361963282860400.jpg"
                                    --%>
                                    <%-- class="d-block w-100" alt="Err">--%>
                                        <%-- </div>--%>
                                            <%-- <div class="carousel-item">--%>
                    ...
                    <div class="box-tab-home ui-tabs ui-corner-all ui-widget ui-widget-content" id="tabs">
                        <div class="container" id="box-home">
                            <div class="menu-tab">
                                <ul class="">
                                    <li><a href="/mua-ban-xe-moi" data-id="carnew">
                                            <h2>Mua xe mới</h2>
                                        </a></li>
                                    <li><a href="/mua-ban-xe-cu-da-qua-su-dung" data-id="carold">
                                            <h2>Tìm xe cũ</h2>
                                        </a></li>
                                    <li><a href="/dang-tin-ban-xe" data-id="buycar">
                                            <h2>Đăng tin ngay</h2>
                                        </a></li>
                                </ul>
                            </div>
                            <div class="slide-selling-brand">
                                <h2 class="heading">Hãng xe bán chạy nhất</h2>
                                <div class="box-list-slide" id="makeBestSaleCar">
                                    <button class="btn-button btn-prev swiper-button-disabled"
                                        ...
                                        data-gtm-vis-total-visible-time-13008071_911="200"
                                        data-gtm-vis-has-fired-13008071_911="1"><i
                                            class="fa-solid fa-circle-chevron-left"></i>
                                        <button class="btn-button btn-next"
                                            data-gtm-vis-recent-on-screen-13008071_911="1534"
                                        ...
                                        <div
                                            class="list-slide brandall-car swiper-container swiper-container-horizontal">
                                            <div class="slide swiper-wrapper">
                                                <div class="item i-toyota swiper-slide swiper-slide-active"
                                                    style="width: 190px;"><a href="/mua-ban-xe-toyota"> <span
                                                            ...
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3> Toyota</h3>
                                                        </span>
                                                    </a></div>
                                                <div class="item i-hyundai swiper-slide swiper-slide-next"
                                                    style="width: 190px;"><a href="/mua-ban-xe-hyundai"> <span
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Hyundai</h3>
                                                        </span> </a></div>
                                                <div class="item i-vinfast swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-vinfast">
                                                        <span data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Vinfast</h3>
                                                        </span> </a></div>
                                                <div class="item i-kia swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-kia"> <span
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>KIA</h3>
                                                        </span> </a></div>
                                                ...
                                                <div class="item i-mitsubishi swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-mitsubishi"> <span
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Mitsubishi</h3>
                                                        </span>
                                                    </a></div>
                                                ...
                                                <div class="item i-suzuki swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-suzuki">
                                                        <span data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Suzuki</h3>
                                                        </span> </a></div>
                                                <div class="item i-bmw swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-bmw"> <span
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>BMW</h3>
                                                        </span> </a></div>
                                                <div class="item i-nissan swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-nissan">
                                                        <span data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Nissan</h3>
                                                        </span> </a></div>
                                                ...
                                                <div class="item i-landrover swiper-slide" style="width: 190px;"><a
                                                        href="/mua-ban-xe-landrover"> <span
                                                            data-gtm-vis-has-fired-13008071_909="1">
                                                            <h3>Landrover</h3>
                                                        </span>
                                                    </a></div>
                                ...
                                <div class="content-tab" id="content-tab"
                                    data-gtm-vis-recent-on-screen-13008071_367="876"
                                    data-gtm-vis-first-on-screen-13008071_367="876"
                                    data-gtm-vis-total-visible-time-13008071_367="100"
                                    data-gtm-vis-has-fired-13008071_367="1">
                                    <div id="carnew" class="content-box">
                                        <h2 class="heading">Tin rao mới nhất</h2>
                                                    ...
                                                    <%-- <div class="col-3">--%>
                                                        <%-- <%@include file="../Component/Item/Car/index.jsp" %>--%>
                                                            <%-- </div>--%>
                                                                <%-- <div class="col-3">--%>
                                                                    <%-- <%@include
                                                                        file="../Component/Item/Car/index.jsp" %>--%>
                                                                        <%-- </div>--%>
                                                                            <%-- <div class="col-3">--%>
                                                                                <%-- <%@include
                                                                                    file="../Component/Item/Car/index.jsp"
